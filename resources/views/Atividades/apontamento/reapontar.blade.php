					...
					<nav>
						<div class="nav-wrapper light-blue z-depth-5">
							<div class="col s12">
								...
								<a class="breadcrumb">Reapontar</a>
							</div>
						</div>
					</nav><br>		
				</div>
				<div class="panel-body">
					<div class="card">
						<div class="card-content">
							<form method="POST" action="{{route('apontamento.reapontar.store')}} ">
								{{csrf_field()}}
								<div class="row">
										<input name="id" type="hidden" value="{{$dados->id}}">
							    <div class="input-field col s4">
										<input name="Safra" type="text" value="2019-teste" disabled>
							        	<label>Safra</label>
							    	</div>
							        <div class="input-field col s4">
										<input name="local" type="text" value="parreiral-teste" disabled >
							        	<label>Local</label>
									</div>
							        <div class="input-field col s4">
										<input name="Atividade" type="text" value="Podar-teste" disabled>
							        	<label>Atividade</label>
									</div>
							        <div class="input-field col s12">
												<input name="quantidade" type="number" value="{{$dados->realizado}}" class="validate" place>
							        ...
							        <div class="input-field col s4">
							          <input name="dt_ini" type="datetime-local" value ="{{$dados->Data_ini_aponta}}" class="validate">
							        </div>
							        <div class="input-field col s1">
