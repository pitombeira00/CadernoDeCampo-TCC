							...
							<form method="POST" action="{{route('local.store')}} ">
								...
								<div class="row">
							        <div class="input-field col s12">
							          <input name="descricao" type="text" class="validate" value="{{ isset($registro->name) ? $registro->name : '' }}">
							          <label>Nome do Usuário</label>
							        </div>
							        <div class="input-field col s12">
							          <input name="email" type="text" class="validate" value="{{ isset($registro->email) ? $registro->email : '' }}">
							          <label>E-mail</label>
							        </div>
							        <div class="input-field col s12">
